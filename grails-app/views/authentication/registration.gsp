    ...
    <div class="card-body">
        <g:form controller="authentication" action="doRegistration">
            ...
            <div class="form-group">
                ...
                <g:textField name="phoneNo" class="form-control" value="${member?.phoneNo}" placeholder="Please Enter Phone No"/>
                <UIHelper:renderErrorMessage fieldName="phoneNo" model="${member}"/>
            </div>
